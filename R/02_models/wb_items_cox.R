...
# tagged by construct-overlap tier; full + 180-day lag period. The novel, non-circular
...
## collapsed covariate block (same as the primary and SWB models)
...
out <- data.frame(item=res$item, tier=res$tier,
                  ...
                  HR_180d_lag=fmt(res$HR_wash,res$lo_w,res$hi_w),
