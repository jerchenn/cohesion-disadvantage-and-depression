# cox_model.R -- primary analysis: cohesion -> incident depression (Cox PH)
library(survival)
...
## sensitivity 1: 6-month lag period (drop events in first 180 days -> guards against prevalent-detection)
...
cat("\n=== 6-month lag period (events =", m2$nevent, ") ===\n")
